				...
				<div class="card-wrapper">
					...
					<div class="card fat">
						<div class="card-body">
							...
							<form method="POST" class="my-login-validation" action="<?php echo base_url() ?>home/check_login">
								...
								<div class="mt-4 text-center">
									Don't have an account? <a href="<?php echo base_url() ?>home/register">Create One</a>
								</div>
							</form>
						</div>
					</div>
